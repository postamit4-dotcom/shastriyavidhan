import { acharyaSursainProfile, contact, pujaModes, servicePages } from "./site-data.js";
...
export const supportPages = [
  ...
  },
  {
    ...
    description:
      "How Shastriya Vidhan keeps devotional, ritual, festival, muhurat, and service content cautious, useful, and evidence-led.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "Pages that require stronger evidence should stay cautious until the booking team verifies the facts.",
        items: [
...
export const modePages = [
  {
    ...
    relatedLinks: [
      ...
      { label: "Book a Puja in Noida", href: "/locations/noida#booking-section" },
      { label: "Pricing & Inclusions", href: "/pricing-and-inclusions" },
      { label: "Puja Guides", href: "/guides" },
    ],
    relatedPanditProfile: {
      eyebrow: "Ghaziabad home puja enquiry",
      heading: "Review the local Pandit Ji profile before a home puja request.",
      bodyBefore: "Families requesting puja at home in Ghaziabad can review the ",
      bodyAfter:
        " before submitting the ceremony, date, locality, and samagri details for manual confirmation.",
      href: acharyaSursainProfile.path,
      anchorText: "public profile of Acharya Sursain Brijwasi",
    },
  },
  {
    slug: "online-puja",
